...
def engineer_features(df: pd.DataFrame) -> pd.DataFrame:
    """Add derived fraud-risk features from raw transaction fields."""
    out = df.copy()
...
class FeatureEngineer(BaseEstimator, TransformerMixin):
    """Sklearn-compatible transformer for inference pipelines."""
...
RAW_FEATURES = ["amount", "location", "device_type", "transaction_hour", "payment_method"]
...
ENGINEERED_NUMERIC_FEATURES = [
    ...
    "is_transfer",
    "is_debit_card",
    "is_transfer_high_value",
    "is_mobile",
    "is_mobile_risky_location",
    "amount_x_late_night",
    "amount_x_transfer",
]

CATEGORICAL_FEATURES = ["location", "device_type", "payment_method"]

BASE_NUMERIC_FEATURES = ["amount", "transaction_hour"]
